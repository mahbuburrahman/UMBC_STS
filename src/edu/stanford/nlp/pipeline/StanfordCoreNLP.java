...
public class StanfordCoreNLP extends AnnotationPipeline {
  ...
  public StanfordCoreNLP(Properties props)  {
    this(props, (props == null ? true : PropertiesUtils.getBool(props, "enforceRequirements", true)));
  }

  public StanfordCoreNLP(AnnotatorPool pool, Properties props) {
    this(pool, props, (props == null ? true : PropertiesUtils.getBool(props, "enforceRequirements", true)));
  }
...
//    }
  ...
  void processFiles(Collection<File> files) throws IOException {
    for (File file : files) {
