...
public class LexicalizedParser implements Function<Object,Tree>, Serializable {
  ...
  public static LexicalizedParser trainFromTreebank(Treebank trainTreebank,
                                                    ...
                                                    Options op) {
    return trainFromTreebank(trainTreebank, compactor, op, null);
  }
  ...
  public static LexicalizedParser trainFromTreebank(Treebank trainTreebank,
    ...
    return getParserFromTreebank(trainTreebank, compactor, op, tuneTreebank);
  }
   ...
   * @param op Options for how the grammar is built from the treebank
   */
  public static LexicalizedParser trainFromTreebank(Treebank trainTreebank, DiskTreebank secondaryTrainTreebank, double weight, GrammarCompactor compactor, Options op) {
    return getParserFromTreebank(trainTreebank, secondaryTrainTreebank, weight, compactor, op);
  }
   ...
   */
  void saveParserToSerialized(String filename) {
    try {
   ...
   * If there is an error, a RuntimeIOException is thrown.
   */
  void saveParserToTextFile(String filename) {
    try {
  ...
  public static Pair<List<Tree>,List<Tree>> getAnnotatedBinaryTreebankFromTreebank(Treebank trainTreebank,
    ...
    TreeTransformer wordFunctionTransformer = null;
    if (op.wordFunction != null) {
      wordFunctionTransformer = new TreeLeafLabelTransformer(op.wordFunction);
    }
    ...
    for (Tree tree : trainTreebank) {
      ...
      if (wordFunctionTransformer != null) {
        tree = wordFunctionTransformer.transformTree(tree);
      }
  ...
  public static void main(String[] args) {
    ...
    if (train) {
      ...
      if (secondaryTreebankPath != null) {
        ...
        lp = trainFromTreebank(trainTreebank, secondaryTrainTreebank, secondaryTreebankWeight, compactor, op);
      } else {
        lp = trainFromTreebank(trainTreebank, compactor, op, tuneTreebank);
      }
