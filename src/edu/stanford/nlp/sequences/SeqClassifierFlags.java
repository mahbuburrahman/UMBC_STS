 ...
 * <p/>
 * 
 * <i>IMPORTANT NOTE IF CHANGING THIS FILE:</i> <b>MAKE SURE</b> TO ONLY ADD NEW
 * VARIABLES AT THE END OF THE LIST OF VARIABLES (and not to change existing
 * variables)! Otherwise you usually break all currently serialized
 * classifiers!!! Search for "ADD VARIABLES ABOVE HERE" below.
 * 
