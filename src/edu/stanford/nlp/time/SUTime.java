...
//      this.timeLabel = t.timeLabel;
 ...
 /*   MILLIS(TimexType.TIME, TimeUnit.MILLIS),
    ...
    public Temporal create(SequenceMatchRules.CompositeValue compositeValue)
    {
...
/*      TimeLabel tl = getTimeLabel();
  ...
  /**
   * Represents a standard partial ISO date
  ...
  public static class IsoDate extends PartialTime {
    ...
    public IsoDate(Integer y, Integer m, Integer d) {
      this.year = y;
      this.month = m;
      this.day = d;
      initBase();
  ...
  protected static class IsoTime extends PartialTime {
    ...
    // TODO: Added for reading rules from file
    public IsoTime(Integer h, Integer m, Integer s) {
      this(h, m, s, Integer.valueOf(-1));
    }
    ...
    // TODO: Added for reading rules from file
    public IsoTime(Integer h, Integer m, Integer s, Integer ms) {
      this.hour = h;
      this.minute = m;
      this.second = s;
      this.millis = ms;
